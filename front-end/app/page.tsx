...
export default async function Home() {
  ...
  return (
    <main className="page-shell">
      ...
      <section className="container mx-auto px-4 sm:px-6 py-14 sm:py-24 border-t-4 border-[var(--color-primary)]">
        <div className="text-center mb-10 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900">Featured Turfs</h2>
        ...
        <div className="text-center mt-10 sm:mt-12">
          <Link
            href="/turfs"
            className="inline-flex w-full sm:w-auto justify-center border-2 border-[var(--color-secondary)] text-[var(--color-secondary)] px-8 py-3 rounded-xl font-bold hover:bg-[var(--color-secondary)] hover:text-white transition-colors"
          >
            View All Turfs
          </Link>
        </div>
