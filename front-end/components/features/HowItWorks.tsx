...
export const HowItWorks = () => (
  <section className="py-14 sm:py-20 bg-[var(--surface-muted)] relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 text-center">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 text-gray-900 relative z-10">How It Works</h2>
      <p className="text-gray-600 mb-10 sm:mb-14 relative z-10">Book your perfect turf in just four simple steps</p>
      
      <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-10 z-10">
        <div className="hidden md:block absolute top-6 left-[8%] right-[8%] h-[2px] bg-[var(--color-primary)]/45" />
        
        {steps.map((step) => (
          <div key={step.id} className="flex flex-col items-center">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-[var(--color-primary)] text-white rounded-full flex items-center justify-center text-xl sm:text-2xl font-bold mb-4 sm:mb-5 shadow-lg border-4 border-[var(--surface-muted)]">
              {step.id}
            </div>
