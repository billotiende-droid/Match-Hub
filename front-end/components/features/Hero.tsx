...
export const Hero = () => (
  <section className="relative bg-[#1a4d2e] dark:bg-black pt-20 pb-32 overflow-hidden text-white">
    <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
      <div className="space-y-6">
        ...
        <p className="text-xl text-gray-300 dark:text-gray-400 max-w-md leading-relaxed">
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          ...
          <button className="bg-black/50 dark:bg-white/10 border border-white/20 dark:border-gray-600 px-8 py-4 rounded-xl font-bold flex items-center gap-2">
      ...
      <div className="relative group">
        ...
        <div className="rounded-[40px] overflow-hidden border-[10px] border-white/10 dark:border-gray-700 shadow-2xl">
