...
export const WhyChooseUs = () => (
  <section className="py-16 sm:py-24 bg-[#0fa218] text-white relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4">Why Choose Match Hub</h2>
      <p className="text-white/90 mb-10 sm:mb-16">Everything you need for the perfect football experience</p>
      
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6">
        {['Find Turfs Near You', 'Easy Booking', 'Join Tournaments', 'Secure Payments'].map((title) => (
          <div key={title} className="bg-white/10 border border-white/20 backdrop-blur-sm p-6 sm:p-8 rounded-2xl text-left">
    ...
    <div className="container mx-auto px-4 sm:px-6 relative z-10">
      <div className="surface-card rounded-[28px] overflow-hidden">
        ...
        <div className="p-6 sm:p-10 md:p-14 text-center">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-gray-900 mb-4">Ready to Play?</h2>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            <Link
              href="/turfs"
              className="w-full sm:w-auto bg-[var(--color-primary)] text-white px-8 py-3 rounded-xl font-bold hover:bg-[var(--color-primary-strong)] transition-colors"
            >
              Browse Turfs
            </Link>
            <Link
              href="/tournaments"
              className="w-full sm:w-auto bg-[var(--color-secondary)] text-white px-8 py-3 rounded-xl font-bold hover:bg-[color-mix(in_oklab,var(--color-secondary)_88%,black)] transition-colors"
            >
              Join Tournament
            </Link>
          </div>
