...
export const Footer = () => {
  ...
  return (
    <footer className="mt-10 sm:mt-12 text-gray-600 dark:text-gray-400 py-12 sm:py-16 border-t border-[var(--color-border)]/70 bg-[color-mix(in_oklab,var(--surface)_96%,transparent)] backdrop-blur">
      <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12">
        <div className="space-y-4 text-center md:text-left">
          <div className="flex items-center justify-center md:justify-start gap-3 text-gray-900 dark:text-white">
        ...
        <div>
          <h4 className="text-gray-900 dark:text-white font-bold mb-4 sm:mb-6">Quick Links</h4>
        ...
        <div>
          <h4 className="text-gray-900 dark:text-white font-bold mb-4 sm:mb-6">Support</h4>
          <ul className="space-y-4 text-sm">
        ...
        <div>
          <h4 className="text-gray-900 dark:text-white font-bold mb-4 sm:mb-6">Contact Us</h4>
          <ul className="space-y-4 text-sm">
      ...
      <div className="container mx-auto px-4 sm:px-6 pt-8 sm:pt-12 mt-8 sm:mt-12 border-t border-[var(--color-border)] text-center text-xs">
